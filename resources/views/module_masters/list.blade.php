...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Module Masters</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{route('home')}}">Dashboard</a>
                    </li>
                    <li class="breadcrumb-item active">Module Masters List</li>
                </ul>
            </div>
            <div class="col-auto">
                <a href="{{route('addModuleMaster')}}" class="btn btn-primary me-1"><i class="fas fa-plus"></i></a>
    ...
    <div id="filter_inputs" class="card filter-card">
        <div class="card-body pb-0">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <button onclick="getModuleMaster()" class="btn btn-primary"><i class="fas fa-search"></i> Filter</button>    
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive" id="moduleMasterList"></div>
                </div>
            </div>
        </div>
    </div>
...
// user list get 
function getModuleMaster(page = false) {
    if (!page) {
        page = 1;
    }
    ...
    $.ajax({
        url: "{{route('moduleMasterList')}}" + `?${params}`,
        success: function(response) {
            // set data
            $('#moduleMasterList').html(response);
        }
    }).done(function() {
        setTimeout(function() {
            // loader hide
...
$(document.body).on('click', '#delete_sure', function() {
    ...
    var id = $(this).val();
    $.ajax({
        url: "{{ route('deleteModuleMaster','') }}/" + id,
        type: 'GET',
        dataType: 'Json',
