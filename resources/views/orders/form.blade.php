                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <select class="select select2" name="status" id="status">
                                                        ...
                                                        <option value="{{$Ostatus['value']}}"
                                                            {{isset($item->status) &&  $item->status === $Ostatus['value']? 'selected' :''}}>
                                    ...
                                    <div class="invoice-total-box">
                                        <div class="invoice-total-footer">
                                            ...
                                            <h4>Total Amount <span
                                                    id="amountDue">{{isset($item->total) ? number_format($item->total,2) :'00.00'}}
                                                    Rs.</span></h4>
                                        </div>
                                            ...
                                            <div class="links-info-one">
                                                <div class="links-cont">
                                                    <div class="service-amount">
                                                        <a href="javascript:void(0);" class="service-trash">Pay
                                                            Amount</a>
                                                        <span><input type="text" class="form-control" name="pay_amount"
                                                                id="pay_amount" placeholder="00.00" value=""
                                                                style="height: 30px;"
                                                                {{(isset($item->paidAmountSum) && !($item->total - $item->paidAmountSum->sum('amount'))) ? 'disabled' : ''}}></span>
                                                    </div>
                                                </div>
                                                <div class="links-cont">
                                                    <div class="service-amount">
