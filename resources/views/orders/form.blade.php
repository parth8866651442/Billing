...
<section class="section">
    <div class="container-fluid">
        ...
        @if(isset($item))
        <form method="POST" action="{{(isset($item)) ? route('updateOrder',['id'=>$item->id]) : route('storeOrder')}}"
                            ...
                            <div class="invoice-address">
                                <div class="address-item">
                                    ...
                                    <div class="input-style-1 mb-2">
                                        <input type="text" name="fullname" id="fullname" class="bg-transparent"
                                ...
                                <div class="address-item">
                                    <div class="input-style-1 mb-2">
                                        <input type="text" name="moblie_no" id="moblie_no" class="bg-transparent"
                                            placeholder="Moblie No"
                                            value="{{isset($item->moblie_no) ? $item->moblie_no :''  }}">
                                    </div>
                                    <div class="input-style-1 mb-2">
                                        <input type="text" name="sip_vehicle_no" id="sip_vehicle_no"
                                            class="bg-transparent" placeholder="Sip Vehicle No"
                            ...
                            <div class="invoice-action">
                                <ul class="d-flex flex-wrap align-items-center justify-content-center">
                                    <li class="m-2">
                                        ...
                                        <a href="{{route('orderList')}}"><button type="button"
