                                ...
                                <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="invoice-details-box">
                                        <div class="invoice-inner-head">
                                            <span>Invoice No.<a href="javascript:void(0);">{{isset($item->invoice_no)? $item->invoice_no : invoiceNumber() }}</a></span>
                                        </div>
                                        ...
                                        <div class="faq-tab">
                                            <div class="panel panel-default">
                                                ...
                                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                                    ...
                                                    <div class="panel-body">
                                                        <textarea
                                                            class="form-control" name="notes">{{isset($settings->notes)? $settings->notes : '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
