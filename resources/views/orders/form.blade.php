    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card invoices-add-card">
                <div class="card-body">
                    <form method="POST" action="{{(isset($item)) ? route('updateOrder',['id'=>$item->id]) : route('storeOrder')}}" class="invoices-form" id="orderForm">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select select2" name="client_id" id="client_id" onChange="customerFindAddress(this.value)">
                                ...
                                <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="invoice-details-box">
                                        <div class="invoice-inner-head">
                                            <span>Invoice No.<a href="javascript:void(0);">IN093439#@09</a></span>
                                        </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="invoice-info">
                                        ...
                                        <p class="invoice-details invoice-details-two" id="clientAddress">
                                            {!! nl2br($item->clientDetail->address) !!}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-center add-table-items">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="add-row">
                                            <td>
                                                <select class="select select2" name="items[0][product_id]" id="product_id-0" onChange="selectProduct(this.value,0)">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="items[0][price]" id="price-0" value="" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="items[0][qty]" id="qty-0" value="1" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="items[0][amount]" id="amount-0" value="" />
                                            </td>
                                        ...
                                        @isset($item->orderItemsDetail)
                                            ...
                                            <tr class="add-row">
                                                <td>
                                                    <input type="hidden" name="items[{{$key}}][item_id]" value="{{$orderitem->id}}">
                                                    <select class="select select2" name="items[{{$key}}][product_id]" id="product_id-{{$key}}" onChange="selectProduct(this.value,{{$key}})">
                                                        <option value="">Select Product</option>
                                                        @foreach($products as $product)
                                                        <option value="{{$product->id}}" data-price="{{$product->price}}" {{isset($orderitem->product_id) &&  $orderitem->product_id === $product->id ? 'selected' :'' }}>{{ $product->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="items[{{$key}}][price]" id="price-{{$key}}" value="{{$orderitem->price}}" />
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="items[{{$key}}][qty]" id="qty-{{$key}}" value="{{$orderitem->qty}}" />
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="items[{{$key}}][amount]" id="amount-{{$key}}" value="{{$orderitem->amount}}" />
                                                </td>
                                                <td class="add-remove text-center">
                                                    @if($key === 0)
                                                    <a href="javascript:void(0);" class="add-btn me-2"><i class="fas fa-plus-circle"></i></a>
                                ...
                                <div class="invoice-total-card">
                                    ...
                                    <div class="invoice-total-box">
                                        <div class="invoice-total-inner">
                                            ...
                                            <a href="javascript:void(0);" class="add-links"> <i class="fas fa-plus-circle me-1"></i> Additional Charges </a>
                                            <div class="links-info-discount">
                                                <div class="links-cont-discount">
                                                    <a href="javascript:void(0);" class="add-links-one"> <i class="fas fa-plus-circle me-1"></i> Add more Discount </a>
                                                    <a href="#" class="service-trash-one"> <i class="feather-trash-2"></i> </a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="invoice-total-footer">
                                            <input type="hidden" name="total" id="total" value="{{isset($item->total) ? $item->total :'00.00'}}">
                                            <h4>Total Amount <span id="amountDue">{{isset($item->total) ? $item->total :'00.00'}} Rs.</span></h4>
                                        </div>
                                    </div>
                                </div>
