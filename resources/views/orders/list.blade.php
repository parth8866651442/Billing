...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="{{route('addOrder')}}" class="btn btn-primary me-1"><i class="fas fa-plus"></i></a>
    ...
    <div id="filter_inputs" class="card filter-card">
        <div class="card-body pb-0">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <button onclick="getOrders()" class="btn btn-primary btn-sm"><i class="lni lni-search-alt"></i> Filter</button>    
                </div>
            </div>
        </div>
    </div>
